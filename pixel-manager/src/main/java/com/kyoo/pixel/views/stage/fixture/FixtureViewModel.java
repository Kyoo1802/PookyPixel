...
import com.kyoo.pixel.views.stage.fixture.interactions.KeyboardInteraction;
import com.kyoo.pixel.views.stage.fixture.interactions.PositionInteraction;
import com.kyoo.pixel.views.stage.fixture.interactions.StateInteraction;
  ...
  public void consumeInteractions() {
    while (hasPendingInteractions()) {
      ...
      switch (interactionRequest.type()) {
        case KEYBOARD:
          keyboardInteraction.handleInteraction(
              interactionRequest.getKeyboardInteractionRequest().get());
          break;
        case POSITION:
          positionInteraction.handleInteraction(
              interactionRequest.getPositionInteractionRequest().get());
          break;
        case STATE:
          stateInteraction.handleInteraction(interactionRequest.getStateInteractionRequest().get());
          break;
        default:
